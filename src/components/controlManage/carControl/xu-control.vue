  ...
  <div>
      <el-form ref="car" :model="car" label-width="100px" :inline="true" v-loading="editLoading">
         ...
         <el-card class="carControl cars carDetail">
            ...
            <div v-for="(list,iIndex) in checkList" :key='iIndex'>
              ...
              <div class="resultsAll" v-if="list.sqlx!=='1'">
                <div class="results" v-if="list.sqlx!=='3'"><span>续控截止时间：</span><span style="font-size:14px">{{list.jssj | dateFormat }}</span></div>
        ...
        <el-card class="carControl cars">
            ...
            <el-row>
                <!-- <el-form-item prop="title" label="续控人">
                  <el-input v-model="booleanFlag" placeholder="请输入续控人" required="true" :disabled="editFlag"></el-input>
                </el-form-item> -->
                 <span style="color:red;position: absolute;left: 0px;top: 5px;">*</span>
             ...
             <el-row>
                  <el-col :span="24">
                    ...
                    <el-form-item prop="title" label="续控原因">
        ...
        <el-row class="footerBtn">
              <el-button type="default" @click="resetForm('续控')">
                取消
              </el-button>
              <el-button type="primary" @click="xuKong('续控')">
                续控
              </el-button>
        </el-row>
     </el-form>
...
<script>
  ...
  import { GET_CAR_INFO_CONTROL, GET_CARRESULT_LIST_BY_BKID_CONTROL, GET_CARRENEW_WARN_CONTROL } from '../../../store/types'
  ...
  export default {
    ...
    methods: {
      xuKong(title) {
        ...
        this.xu.jssj = this.dateFormat(new Date(this.xu.jssj), 'yyyy-MM-dd')
        if(this.xu.sqly === '' || this.xu.sqly === undefined) {
          ...
          return;
        }else if (this.xu.jssj === '' || this.xu.jssj === undefined) {
          this.$message({
            type: 'error',
            message: '续控时间不能为空'
          });
        ...
        var data1 = new Date(this.car.jssj);
        var data2 = new Date(this.xu.jssj);
        if(parseInt(data1.getTime()) > parseInt(data2.getTime())) {
          this.$message({
            message: '续控时间不能小于布控结束时间',
            type: 'error'
          });
          return;
        }
        this.dispatch(GET_CARRENEW_WARN_CONTROL, this.xu).then(() => {
          this.$message({
            type: 'success',
            message: '续控成功'
          });
