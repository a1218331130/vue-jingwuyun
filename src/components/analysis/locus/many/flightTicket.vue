    ...
    <div class="tabs-box">
      <div class="tabs-box__item" v-for="(item,i) in tabs" v-show="i===currentTab">
        ...
        <div class="app-content-box">
          ...
          <el-tabs v-show="detailBox===true">
            <el-tab-pane label="共同联系人分析">
              <div class="spc-tab-right-box">
                <el-button @click="mainGo.setLayout('GridLayout')">网格</el-button>
                <el-button @click="mainGo.setLayout('LayeredDigraphLayout')">分层</el-button>
                <el-button @click="mainGo.setLayout('CircularLayout')">圆形</el-button>
                <el-button @click="mainGo.setLayout('ForceDirectedLayout')">反牵引力</el-button>
                <el-button @click="mainGo.setLayout('TreeLayout')">树形</el-button>
              </div>
              <div :span="24" id="goBox" class="maker canvas-board" style="height: 400px"></div>
              <div id="overViewBox" class="overview-box"></div>
            </el-tab-pane>
          </el-tabs>
        </div>
