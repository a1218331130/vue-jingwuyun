            ...
            <el-form :model="item.queryForm" :inline="true" label-position="right" label-width="90px">
              ...
              <el-form-item label="同上网规则" labelWidth="110px">
                <el-select class="small" v-model="item.queryForm.online" placeholder="请选择">
                  <el-option v-for="item in onlineList" :label="item.label" :value="item.value"
                             :key="item.value"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="前后时间偏移" labelWidth="120px">
                <el-input-number v-model="item.queryForm.toTime" size="small" :min="1" :max="1000"
                ...
                <li>
                  ...
                  <div class="list-right">
                    ...
                    <el-row :gutter="20">
                      ...
                      <el-col :span="10">
                        <div class="listbox">
                          <span class="listtitle">网吧名称：</span>{{wb.wbmc}}</div>
                      </el-col>
                    </el-row>
                    <!--<el-row :gutter="20">-->
                      <!--<el-col :span="24">-->
  ...
  export default {
    ...
    data() {
      return {
        ...
        table: {
          columns: [{label: '分析人姓名', prop: 'findPeopleName', note: 'fxrxm'}, {
            label: '开始时间',
            prop: 'startTime',
            note: 'kssj'
