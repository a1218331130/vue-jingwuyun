...
export default {
  ...
  mounted() {
    ...
    this.yearCountOps.legend.data = ['申请数']
    this.yearCountOps.series[0].name = '申请数'
    this.yearCountOps.series[0].data = [32, 27, 36, 34, 28, 32, 27, 36, 34, 28, 32, 27]

    // 警种柱图数据
    this.cateCountOps = clone(this.echartsBarOptions.stack)
    this.cateCountOps.xAxis.axisLabel.rotate = '0'
    this.cateCountOps.xAxis.data = ['情报', '网安', '法制', '技侦', '经侦', '治安', '刑侦', '出入境']
    // this.cateCountOps.legend.data = ['申请数', '待签收', '待反馈', '待评价', '已完成']
    this.cateCountOps.legend.data = ['申请数', '完成数']
    this.cateCountOps.series[0].name = '申请数'
    ...
    // this.cateCountOps.series[2] = clone(this.cateCountOps.series[0])
    // this.cateCountOps.series[2].name = '待反馈'
    // this.cateCountOps.series[2].data = [22, 17, 36, 34, 28, 22, 27, 26]
    // this.cateCountOps.series[3] = clone(this.cateCountOps.series[0])
    // this.cateCountOps.series[3].name = '待评价'
    // this.cateCountOps.series[3].data = [22, 17, 36, 34, 28, 22, 27, 26]
    // this.cateCountOps.series[4] = clone(this.cateCountOps.series[0])
    // this.cateCountOps.series[4].name = '已完成'
    // this.cateCountOps.series[4].data = [22, 17, 36, 34, 28, 22, 27, 26]

    // 各单位申请柱图数据
    this.resCountOps = clone(this.echartsBarOptions.horizontalType)
    this.resCountOps.xAxis.data = ['洪江区公安局情报中心', '刑事侦查支队基础情报信息大队', '鹤城分局法制大队', '市局网监与行动技术支队', '洪江区公安局网络安全保卫大队', '市局刑事侦查支队基础情报信息大队', '市局警令部情报中心', '沃溪分局刑事侦查大队']
    this.resCountOps.legend.data = ['申请数']
    this.resCountOps.series[0].name = '申请数'
