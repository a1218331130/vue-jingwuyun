      ...
      <el-form ref="controlForm" :model="controlForm" label-width="100px" :rules="rules" :inline="true">
         ...
         <el-card class="carControl cars">
            <div class="clearfix" slot="header">
             ...
             <el-row>
                <el-col :span="6" style="position: absolute;opacity: 0">
                 ...
                 <el-col :span="6">
                     <el-form-item prop="caseName" label="案件名称">
                      <el-input v-model="controlForm.caseName" required="true" :disabled="true"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
        ...
        <el-card class="carControl cars" v-if="xtTitles==='查看详情' && controlForm.zcResult!==null">
            <div class="clearfix" slot="header">
              <span>办理结果</span>
            </div>
            <el-row>
                  ...
                  <el-col :span="24">
                     <el-form-item prop="title" label="附件"> 
        ...
        <el-card class="carControl cars" v-if="xtTitles!=='查看详情'">
            <div class="clearfix" slot="header">
              <span>办理结果</span>
            </div>
             <!-- <el-row>
            ...
            <el-row>
                  <el-col :span="24">
                    <el-form-item prop="title" label="侦查意见">
                      <el-input v-model="approveData.zcResult" required="true" type="textarea" style="width:1200px" :rows="3"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="24">
        ...
        <el-row class="footerBtn" v-if="xtTitles!=='查看详情'">
             <el-button type="default" @click="resetForm('办理')">
                取消
              </el-button>
              <el-button type="primary" @click="submitForm('办理')">
                办理
              </el-button>
        </el-row>
        <el-row class="footerBtn" v-if="xtTitles==='查看详情'">
          <el-button type="primary" @click="ifSign(xtObjs.id, '查看详情')" v-if="xtObjs.tabId===1">
            签收
          </el-button>
...
<script>
  ...
  import { GET_APPLY_PERSON_INFO, GET_CUR_USER_CASE_LIST, XT_GET_CASE_INFO, XT_VIEW_DETAIL, XT_HANDLE, XT_SIGN } from '../../../store/types'
        ...
        if(val) {
          if(this.xtTitles === '办理') {
            ...
            this.approveData = {
              ...
              approvaNode: this.xtObjs.approvaNode,
            ...
            // var myIp = ipList[2]
            this.editFlag = true;
            // this.uploadId = myIp + '/jwy/DownFile.ashx?id=' + this.xtObjs.attachmentId;
            // this.uploadIdAll = myIp + '/jwy/DownFile.ashx?id=' + this.xtObjs.zcAttachmentid;
            this.getDetail(this.xtObjs.applyId);
          }
        }
      }
    ...
    methods: {
      ...
      ifSign(sign, title) {
        this.$confirm('确定要签收此项?', '温馨提示', {
          ...
          this.loading = true
          this.dispatch(XT_SIGN, { id: sign }).then(() => {
            this.$message({
              type: 'success',
              message: '签收成功'
            })
      ...
      // 提交申请
      postAdd(title) {
        this.dispatch(XT_HANDLE, this.approveData).then(() => {
          // alert(this.union.xtHandle);
          this.$message({
            message: this.union.xtHandle,
            type: 'success'
          });
          this.$emit('closeTabs', title)
        })
      ...
      uploadSubmit(f) {
        ...
        if (f.Status === 1) {
          ...
          this.controlForm.zcattachmentId = _fileIdArray.join()
      ...
      getDetail(ids) {
        this.dispatch(XT_VIEW_DETAIL, {applyId: ids}).then(() => {
          ...
          console.log(this.controlForm, '戴先生');
