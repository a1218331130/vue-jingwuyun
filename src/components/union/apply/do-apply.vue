      ...
      <el-form ref="controlForm" :model="controlForm" label-width="100px" :rules="rules" :inline="true">
        ...
        <el-card class="carControl cars">
            ...
            <el-row class="applyMessage" v-if="xtTitles==='编辑'&& editType ===false">
                ...
                <el-form-item prop="xtTitle" label=""> 
                  <span style="padding-right:20px">{{controlForm.fileName}}</span>
            ...
            <el-row class="applyMessage" v-if="xtTitles!=='编辑'">
                ...
                <el-col :span="8" class="title">
                  <span style="color: #ff4949;">{{controlForm.fileName}}</span>
                </el-col>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="质量">
                  <el-rate v-model="formComment.qualityScore" allow-half show-text></el-rate>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="效率">
                  <el-rate v-model="formComment.efficiencyScore" allow-half show-text></el-rate>
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="评价">
                  <el-input v-model="formComment.evaluativeInfo" placeholder="请输入评价" required="true" type="textarea" style="width:1200px" :rows="3"></el-input>
              ...
              <el-col :span="12">
                <el-form-item label="抓获人数">
                  ...
                  <!-- <el-input-number v-model="formComment.victoryPerson" placeholder="" :min="0" :disabled="formComment.res===0"></el-input-number> -->
                </el-form-item>
              </el-col>
            </el-row>
        </el-card> 
      ...
      xtObjs (val) {
        if(val) {
          if(this.xtTitles === '查看详情') {
            ...
            this.editFlag = true;
            this.controlForm = this.xtObjs;
            this.getDetailcomment(this.xtObjs.detailid);
          }else if(this.xtTitles === '编辑') {
            this.editFlag = false;
            this.controlForm = this.xtObjs;
          }
