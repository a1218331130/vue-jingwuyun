      ...
      <el-row :gutter="5">
        <el-col :span="8">
          <el-form-item label="证件类型" prop="zjlx">
            <el-select placeholder="请选择" v-model="editForm.zjlx" filterable style="width: 100%">
              <el-option :label="item.label" :value="item.value" :key="index" v-for="(item,index) in dictLists['PCZJLX']" style="width: 100%"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="证件号码" prop="zjhm">
            <el-input v-model="editForm.zjhm" :maxlength="18"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="中文姓名" prop="zwxm">
            <el-input v-model="editForm.zwxm" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="外文姓" prop="wwx">
            <el-input v-model="editForm.wwx" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="外文名" prop="wwm">
            <el-input v-model="editForm.wwm" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="社会关系" prop="gx">
            <el-select placeholder="请选择" v-model="editForm.gx" filterable style="width: 100%">
              <el-option :label="item.label" :value="item.value" :key="index" v-for="(item,index) in dictLists['SHGX']" style="width: 100%"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="固定职业" prop="sfygdzy">
            <el-input v-model="editForm.sfygdzy" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="16">
        ...
        <el-col :span="8">
          <el-form-item label="登记人姓名" prop="cjrxm">
            <el-input v-model="editForm.cjrxm" :disabled="true" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="登记人单位" prop="cjdwmc">
            <el-input v-model="editForm.cjdwmc" :disabled="true" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="登记时间" prop="cjsj">
            <el-date-picker v-model="editForm.cjsj" :disabled="true" type="datetime" style="width: 100%"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="操作人姓名" prop="xgrxm">
            <el-input v-model="editForm.xgrxm" :disabled="true" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="操作单位" prop="xgdwmc">
            <el-input v-model="editForm.xgdwmc" :disabled="true" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="操作时间" prop="xgsj">
            <el-date-picker v-model="editForm.xgsj" type="datetime" :disabled="true" style="width: 100%"></el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    queryDictType() {
      //  表单字典初始化
      this.getDict(['PCZJLX', 'SHGX', 'XBDM']).then(res => {
        this.dictLists = res
      })
    },
    /**
    ...
    submit() {
      this.$refs['knowEditForm'].validate(v => {
        if(v) {
          ...
          this.editForm.csrq = this.dateFormat(new Date(this.editForm.csrq), 'yyyy-MM-dd hh:mm:ss')
          // this.editForm.cjsj = this.dateFormat(new Date(this.editForm.cjsj), 'yyyy-MM-dd hh:mm:ss')
          // this.editForm.xgsj = this.dateFormat(new Date(this.editForm.xgsj), 'yyyy-MM-dd hh:mm:ss')
