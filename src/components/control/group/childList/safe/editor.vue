...
<div class="group_add_from">
  <el-dialog v-draggable="dialogDraggableOptions" style="overflow:hidden" :visible.sync="dialog" :title="dialogMode==='edit'?'修改':'新增'" :modal-append-to-body="true" :append-to-body="true" size="bigest" :modal="false" :close-on-click-modal="false" @open="initDialog"
    ...
    <el-form v-if="editForm!==null" ref="knowEditForm" :rules="rulForm" :model="editForm" label-width="110px">
      <el-row :gutter="5">
        <el-col :span="12">
          <el-form-item label="排查类型" prop="pclx">
            <el-input v-model="editForm.pclx" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="风险等级" prop="fxdj">
            <el-select placeholder="请选择" v-model="editForm.fxdj" filterable style="width: 100%">
        ...
        <el-col :span="12">
          <el-form-item label="风险值" prop="fxz">
            <el-input v-model="editForm.fxz" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="隐患性质" prop="yhxz">
            <el-select placeholder="请选择" v-model="editForm.yhxz" filterable style="width: 100%">
              <el-option :label="item.label" :value="item.value" :key="index" v-for="(item,index) in dictLists['YHXZ']" style="width: 100%"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="24">
          <el-form-item label="风险隐患点" prop="fxyhd">
            <el-input v-model="editForm.fxyhd" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="风险隐患描述" prop="fxyhms">
            <el-input type="textarea" placeholder="请输风险隐患描述" :autosize="{minRows: 12, maxRows: 50}" v-model="editForm.fxyhms"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="5">
...
.group_add_from .el-dialog__body {
  background: #ebf5fc;
}
</style>
<script>
