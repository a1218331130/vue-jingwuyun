<template>
<el-dialog v-draggable="dialogDraggableOptions" title="走访记录" :visible.sync="dialogVisit" height="500" :before-close="close" @open="start()" size="bigest">
  <el-table @cell-mouse-enter="cellMouseEnter" v-if="isEdit===false" :data="visitList" height="500" border @row-dblclick="rowDblclick" v-loading="loading">
    ...
    <el-table-column prop="visitTimeStr" label="走访时间"></el-table-column>
  ...
  <div v-if="isEdit===false" class="app-toolbar">
  ...
  <div class="visit-add" v-if="isEdit===true">
    ...
    <el-form :model="form" label-width="110px" ref="form" :rules="rules" style="padding:10px">
      ...
      <el-row :gutter="10">
        <el-col :span="12">
          <el-form-item label="核实地点" prop="visitVerifyAddress">
            <el-input :maxlength="50" v-model="form.visitVerifyAddress"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="核实时间" prop="visitTime">
      ...
      <el-row :gutter="10">
        <el-col :span="24">
          <el-form-item label="判断依据">
            <el-input type="textarea" placeholder="限制200个字符" :maxlength="200" v-model="form.visitDoubtfulGist"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="10">
        <el-col :span="24">
          <el-form-item label="走访情况" prop="visitDescribe">
            <el-input type="textarea" placeholder="限制200个字符" :maxlength="200" v-model="form.visitDescribe"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="10">
        <el-col :span="24">
          <el-form-item label="去往何处">
            <el-input type="textarea" placeholder="限制200个字符" :maxlength="200" v-model="form.visitAddress"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="10">
        <el-col :span="24">
          <el-form-item label="添加附件">
            <div class="wrap-box__content" id="handle-visit-dialog">
              <input type="hidden" v-model="form.visitAccessory" />
              <upload :uploadType="'picture'" :isSinglePic="false" :isFormalSubmit="isFormalSubmit" @upload:submit="uploadSubmit" list-type="picture-card" :currentFiles="currentFiles">
                <!-- <el-button slot="button" type="primary">上传附件222</el-button> -->
              </upload>
            </div>
          </el-form-item>
        </el-col>
  ...
  <div slot="footer" class="dialog-footer">
    ...
    <el-button v-if="isEdit===false" type="primary" @click="edit()">新增</el-button>
...
<style lang="scss">
#handle-visit-dialog.wrap-box__content {
...
import upload from '../../../widgets/upload/upload-dialog.vue'
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        visitTime: [
          { type: 'date', required: true, message: '请输入走访时间', trigger: 'blur' }
        ],
        visitDescribe: [
          { required: true, message: '请输入走访情况', trigger: 'blur' }
        ],
        visitUnit: [
  ...
  methods: {
    start() {
      this.loading = true
      this.form.visitName = this.object.xm
      this.form.visitIdCard = this.object.sfz
      this.form.RyId = this.object.id
      this.dispatch(GET_PERSON_VISIT_INFO, {
        ...
        this.visitList = this.personVisit.PageData.map(c => {
          return {
            ...
            visitTime: new Date(Date.parse(c.VerifyTime)),
            visitTimeStr: this.dateFormat(new Date(Date.parse(c.VerifyTime)), 'yyyy-MM-dd'),
