...
<div style="height:100%">
  ...
  <div>
    <el-row :gutter="5">
      ...
      <el-col :span="8">
        <el-form-item label-width="106px" label="所属市州" prop="sssz">
          <el-input :maxlength="50" vv-model="value.sssz"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label-width="106px" label="工商登记时间" prop="gsdjsj">
          <el-date-picker v-model="value.gsdjsj" type="datetime" style="width: 100%"></el-date-picker>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label-width="106px" label="经营范围" prop="jyfw">
          <el-input :maxlength="50" vv-model="value.jyfw"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
      ...
      <!-- <el-col :span="6" label="工作抓手" prop="Address">
        <el-input :maxlength="50" vv-model="form.Address"></el-input>
      </el-col> -->
    </el-row>
    <el-col :span="8">
      <el-form-item label-width="106px" label="登记人" prop="djr">
        <el-input :maxlength="50" vv-model="value.djr"></el-input>
      </el-form-item>
    </el-col>
    <el-col :span="8">
      <el-form-item label-width="106px" label="登记单位" prop="djdw">
        <el-input :maxlength="50" vv-model="value.djdw"></el-input>
      </el-form-item>
    </el-col>
    <el-col :span="8">
      <el-form-item label-width="106px" label="登记时间" prop="djsj">
    ...
    <el-row :gutter="5">
      ...
      <el-col :span="16">
        <el-form-item label-width="106px" label="销售商详细地址" prop="xxdz">
          <el-input :maxlength="50" vv-model="value.xxdz"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label-width="106px" label="目前生成情况" prop="sczk">
          <el-input :maxlength="50" vv-model="value.sczk" placeholder="截至目前生成情况（数量）"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
