...
<el-table-column align="center" label="操作单位名称" prop="czdwmc"></el-table-column>
<el-table-column align="center" label="操作类型名称" prop="czlxmc"></el-table-column>
<el-table-column align="center" label="操作描述" prop="czms"> </el-table-column>
<el-table-column align="center" label="操作人姓名" prop="czrxm"></el-table-column>
<el-table-column align="center" label="操作时间" prop="czsj"></el-table-column>
</el-table>
