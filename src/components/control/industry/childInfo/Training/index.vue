    ...
    <el-row :gutter="5">
      <el-col :span="24">
        <el-form-item label="培训机构名称 " prop="xssmc" label-width="106px">
          <el-input :maxlength="50" v-model="value.xssmc" style="width: 100%"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="8">
        <el-form-item label="授权情况 " prop="sqqk" label-width="106px">
          <el-input :maxlength="50" v-model="value.sqqk"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="5">
      <el-col :span="8">
        <el-form-item label="法人/责任人" prop="fadb" label-width="106px">
          <el-input :maxlength="50" v-model="value.fadb"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="责任人身份证" prop="fasfz" label-width="106px">
          <el-input :maxlength="50" v-model="value.fasfz" placeholder="法人/责任人身份证"></el-input>
          </el-select>
        </el-form-item>
      </el-col>
      <el-col :span="8">
    ...
    <el-row :gutter="5">
      ...
      <el-col :span="8">
        <el-form-item label="登记单位 " prop="djdw" label-width="106px">
          <el-input :maxlength="50" v-model="value.djdw"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8">
      ...
      <el-col :span="24">
        <el-form-item label="机构详细地址 " prop="xxdz" label-width="106px">
          <el-input :maxlength="50" v-model="value.xxdz" placeholder="培训机构详细地址"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">
        <el-form-item label="备注" prop="bz1" label-width="106px">
          <el-input :maxlength="50" v-model="value.bz1"></el-input>
        </el-form-item>
      </el-col>
