...
<script>
  ...
  export default {
    ...
    watch: {
      chartData(val) {
        this.zdData = this.chartData[7].car
        // 饼图数据
        ...
        this.pieTestOps.series[0].data = [
          { name: '怀化市', value: this.chartData[2].totalAreaCar.hhs },
          { name: '麻阳', value: this.chartData[2].totalAreaCar.mymzzzx },
          { name: '会同', value: this.chartData[2].totalAreaCar.htx },
          { name: '洪江', value: this.chartData[2].totalAreaCar.hjs },
          { name: '鹤城', value: this.chartData[2].totalAreaCar.hcq },
          { name: '辰溪', value: this.chartData[2].totalAreaCar.cxx },
          { name: '芷江', value: this.chartData[2].totalAreaCar.zjdzzzx },
          { name: '沅陵', value: this.chartData[2].totalAreaCar.ylx },
          { name: '溆浦', value: this.chartData[2].totalAreaCar.xpx },
          { name: '新晃', value: this.chartData[2].totalAreaCar.xhdzzzx },
          { name: '靖州', value: this.chartData[2].totalAreaCar.jzmzdzzzx },
          { name: '通道', value: this.chartData[2].totalAreaCar.tddzzzx },
          { name: '中方', value: this.chartData[2].totalAreaCar.zfx }
        ]
