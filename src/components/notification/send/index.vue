...
<div>
  ...
  <!-- 中心内容 -->
  <noticeList ref="list" :listType="listType" :draft="false" :send="true" :listOfdetail="listOfdetail" v-if="active===2"></noticeList>
  <dialog-editor :dialog="editorDialog" :data="editData" @close="editorDialog=false" :RcvUserList="RcvUserList" @openNotifPersonDialog="chooseNotifPersonDialog = true"></dialog-editor>
...
export default {
  ...
  methods: {
    ...
    add() {
      // this.$refs.list.editorDialog = true
      this.editData = null
