...
<div>
  ...
  <!-- 中心内容 -->
  <noticeList ref="list" :listType="listType" :send="false" :listOfdetail="listOfdetail" v-if="active===2" @call:edit="edit"></noticeList>
  <dialog-editor :dialog="editorDialog" :data="editData" @close="editorDialog=false" :RcvUserList="RcvUserList" @openNotifPersonDialog="chooseNotifPersonDialog = true" @rectlist="rectlist"></dialog-editor>

  <user-selector :dialog="chooseNotifPersonDialog" @update:value="updateUserSelect" @close="chooseNotifPersonDialog=false"></user-selector>
