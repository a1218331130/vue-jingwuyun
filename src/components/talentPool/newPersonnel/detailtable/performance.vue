<template>
<el-dialog v-draggable="dialogDraggableOptions" :visible.sync="dialog" title="主要奖惩情况" :modal-append-to-body="false" :append-to-body="true" size="large" :modal="false" @open="initDialog" :before-close="closeEvent" style="width:700px;margin:0 auto">
