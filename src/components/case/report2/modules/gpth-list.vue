...
<div>
  <!-- 标题 -->
  <card-header title="高频通话" :tool="false" :add="true" @call:add="add"></card-header>
  <!-- 内容 -->
  <el-row :gutter="10" class="certificate-box">
    <el-col :span="24">
      <el-table :data="tableList" border>
        <el-table-column type="index" label="序号" width="70"></el-table-column>
        <el-table-column prop="zjhm" label="本机号码"></el-table-column>
        <el-table-column prop="dfhm" label="对方号码"></el-table-column>
        <el-table-column prop="xm" label="姓名" width="80"></el-table-column>
        <el-table-column prop="dfsfzhm" label="对方身份证号码"></el-table-column>
        <el-table-column prop="thcs" label="通话次数"></el-table-column>
        <el-table-column prop="thsc" label="通话时长"></el-table-column>
        <el-table-column prop="scthsj" label="首次通话时间"></el-table-column>
        <el-table-column prop="zhthsj" label="最后通话时间"></el-table-column>
