      ...
      <el-row :gutter="5">
        <el-col :span="8">
          <el-form-item label="标题" prop="bt">
            <el-input v-model="editForm.bt" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="信息种类" prop="xxzl">
            <el-input v-model="editForm.xxzl" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="信息真实性" prop="xxzsx">
            <el-input v-model="editForm.xxzsx" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="信息预警性" prop="xxyjx">
            <el-input v-model="editForm.xxyjx" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="信息来源" prop="xxly">
            <el-input v-model="editForm.xxly" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="涉及事件" prop="sjsj">
            <el-input v-model="editForm.sjsj" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
  ...
  methods: {
    ...
    initDialog() {
      ...
      if (this.dialogMode === 'edit') {
        ...
        // this.editForm.cjdwmc = this.users.UserLogin.UserData.DeptName
        // this.editForm.cjsj = this.dateFormat(new Date(), 'yyyy-MM-dd hh:mm:ss')
        this.editForm.xgr = this.users.UserLogin.UserData.UserName
        this.editForm.xgdw = this.users.UserLogin.UserData.DeptName
        this.editForm.xgsj = this.dateFormat(new Date(), 'yyyy-MM-dd hh:mm:ss')
      }
      this.reset()
