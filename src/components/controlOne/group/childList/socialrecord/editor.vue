      ...
      <el-row :gutter="5">
        <el-col :span="8">
          <el-form-item label="开始时间" prop="kssj">
            <el-date-picker :maxlength="50" v-model="editForm.kssj" placeholder="请选择" style="width: 100%"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="结束时间" prop="jssj">
            <el-date-picker :maxlength="50" v-model="editForm.jssj" placeholder="请选择" style="width: 100%"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="职务" prop="zw">
            <el-input v-model="editForm.zw" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="学习服务场所" prop="xxfwcs">
            <el-input v-model="editForm.xxfwcs" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="5">
