      ...
      <el-row :gutter="5">
        <el-col :span="12">
          <el-form-item label="违法时间" prop="wfsj">
            <el-date-picker :maxlength="50" v-model="editForm.wfsj" placeholder="请选择" style="width: 100%"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="违法地点" prop="wfdd">
            <el-input v-model="editForm.wfdd" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="简要情况" prop="jyqk">
            <el-input v-model="editForm.jyqk" :maxlength="50"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="证据情况" prop="zjqk">
