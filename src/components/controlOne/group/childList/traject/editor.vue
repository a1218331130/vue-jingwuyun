      ...
      <el-row :gutter="5">
        <el-col :span="8">
          <el-form-item label="起始时间" prop="qssj">
            <el-date-picker v-model="editForm.qssj" type="datetime" style="width: 100%"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="结束时间" prop="jssj">
            <el-date-picker v-model="editForm.jssj" type="datetime" style="width: 100%"></el-date-picker>

          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="信息类别" prop="dtxxlb">
            <el-select placeholder="请选择" v-model="editForm.dtxxlb" filterable style="width: 100%">
              <el-option :label="item.label" :value="item.value" :key="index" v-for="(item,index) in dictLists['DTXXLB']" style="width: 100%"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="活动发生区域" prop="hdfsqy">
            <el-input v-model="editForm.hdfsqy" :maxlength="500"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="活动发生场所" prop="hdfscs">
            <el-input v-model="editForm.hdfscs" :maxlength="500"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="活动发生详址" prop="hdfsxz">
            <el-input v-model="editForm.hdfsxz" :maxlength="500"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
