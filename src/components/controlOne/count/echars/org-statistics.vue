...
<script>
  ...
  export default {
    ...
    watch: {
      chartData(val) {
        if (val[7].org) {
          this.zdData = this.chartData[7].org
          // 饼图数据
          ...
          this.pieTestOps.series[0].data = [
            { name: '怀化市', value: this.chartData[4].OrgAreaTotal.hhs },
            { name: '麻阳', value: this.chartData[4].OrgAreaTotal.mymzzzx },
            { name: '会同', value: this.chartData[4].OrgAreaTotal.htx },
            { name: '洪江', value: this.chartData[4].OrgAreaTotal.hjs },
            { name: '鹤城', value: this.chartData[4].OrgAreaTotal.hcq },
            { name: '辰溪', value: this.chartData[4].OrgAreaTotal.cxx },
            { name: '芷江', value: this.chartData[4].OrgAreaTotal.zjdzzzx },
            { name: '沅陵', value: this.chartData[4].OrgAreaTotal.ylx },
            { name: '溆浦', value: this.chartData[4].OrgAreaTotal.xpx },
            { name: '新晃', value: this.chartData[4].OrgAreaTotal.xhdzzzx },
            { name: '靖州', value: this.chartData[4].OrgAreaTotal.jzmzdzzzx },
            { name: '通道', value: this.chartData[4].OrgAreaTotal.tddzzzx },
            { name: '中方', value: this.chartData[4].OrgAreaTotal.zfx }
          ]
