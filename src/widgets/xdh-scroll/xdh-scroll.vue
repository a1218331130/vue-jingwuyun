...
<div :class="wrapClasses" style="touch-action: none;">
  <div :class="scrollContainerClasses" :style="{height: height + 'px'}" @scroll="handleScroll" @wheel="onWheel" @touchstart="onPointerDown" ref="scrollContainer">
    <div v-show="false">
      <div :class="loaderClasses" :style="{paddingTop: wrapperPadding.paddingTop}" ref="toploader" v-loading.body="showTopLoader" :element-loading-text="loadingText" :element-loading-spinner="loadingSpinner">
      </div>
    </div>
    ...
    <div v-show="false">
      <div :class="loaderClasses" :style="{paddingBottom: wrapperPadding.paddingBottom}" ref="bottomLoader" :element-loading-text="loadingText" :element-loading-spinner="loadingSpinner">
      </div>
    </div>
  </div>
</div>
...
export default {
  ...
  methods: {
    ...
    resList() {
      return this.personList || this.carList || this.caseList
    },
    onScroll() {
      if (this.isLoading || this.resList().length === this.total) return
